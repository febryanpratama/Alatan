                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('categories.update', [$category->id]) }}" method="post">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" placeholder="Name" required="" name="name" class="form-control" value="{{ $category->name }}">
                        </div>
                        <div class="form-group mb-2">
                            <label for="template" class="mb-2">Template</label>
                            <input type="text" placeholder="Template" required="" name="template" class="form-control" value="{{ $category->template }}">
                        </div>
                        <div class="form-group mb-2">
